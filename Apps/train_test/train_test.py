...
"""
numberOfMinites = input("Enter number of minutes: ")
print(f'A customer in the shop for  {numberOfMinites} min will spend ${mymodel(int(numberOfMinites))}')